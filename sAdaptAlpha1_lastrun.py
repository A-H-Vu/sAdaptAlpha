...
expName = 'sAdaptAlpha1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\sAdaptAlpha\\sAdaptAlpha1_lastrun.py',
...
for thisSelectLoop in selectLoop:
    ...
    for thisTrial in trials:
        ...
        if counter == 1:
            ...
            trialNum.text = str(trials.thisN+1)+' / 36'
        ...
        if counter == 4 or counter == 8:
            targetangle = targetAngles[0][trials.thisN % 2]
            targetangle_rad = pi*(targetangle/180)
            targetPos = (cos(targetangle_rad)*0.4, sin(targetangle_rad)*0.4)
        ...
        if counter == 5 or counter == 9:
            ...
            targetangle = targetAngles[loopCount][trials.thisN % 2] # Alternate between the 2 choices
            targetangle_rad = pi*(targetangle/180)
            targetPos = (cos(targetangle_rad)*0.4, sin(targetangle_rad)*0.4)
        ...
        while continueRoutine:
            ...
            if counter == 4 or counter == 8:
                CursorTargetDistance = sqrt((trialCursor.pos[0]-trialTarget.pos[0])**2 + (trialCursor.pos[1]-trialTarget.pos[1])**2)
                CursorHomeDistance = sqrt(trialCursor.pos[0]**2 + trialCursor.pos[1]**2)
                cursorPosX = (trial2Mouse.getPos()[0]*cos(rtd))-(trial2Mouse.getPos()[1]*sin(rtd))
                CursorPosY = (trial2Mouse.getPos()[0]*sin(rtd))+(trial2Mouse.getPos()[1]*cos(rtd))
            ...
            if counter == 5 or counter == 9:
                CursorTargetDistance = sqrt((trialCursor.pos[0]-trialTarget.pos[0])**2 + (trialCursor.pos[1]-trialTarget.pos[1])**2)
                CursorHomeDistance = sqrt(trialCursor.pos[0]**2 + trialCursor.pos[1]**2)
                cursorPosX = (trial3Mouse.getPos()[0]*cos(rtd))-(trial3Mouse.getPos()[1]*sin(rtd))
                CursorPosY = (trial3Mouse.getPos()[0]*sin(rtd))+(trial3Mouse.getPos()[1]*cos(rtd))
